...
import com.example.Code.School.email.EmailSender;
import com.example.Code.School.model.UserCredentials;
import com.example.Code.School.model.UserRole;
...
public class RegistrationService {
    ...
    public String confirmToken(String token) {
        ...
        userCredentialsService.enableUserCredentials(
                confirmationToken.getUserCredentials().getEmail());
